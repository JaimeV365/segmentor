...
## Can I filter or exclude certain customers?
**Keywords:** filter customers, exclude customers, hide customers

Yes! The tool offers several filtering options:
...
- **Exclude customers:** Temporarily hide specific customers from analysis

Use the filter panel to combine multiple filters and narrow down your analysis to specific customer segments.

## Can I adjust the quadrant boundaries?
**Keywords:** adjust midpoint, move quadrants, reposition centre
...
**Keywords:** manual reassignment, change quadrant, override classification
...
**Keywords:** chart controls, visualisation settings, display options
...
## Can I edit, delete, or hide customer entries?
**Keywords:** edit data, modify entries, update customer, hide entries

Yes. In the data table:

- Click the edit icon to modify satisfaction or loyalty scores
- Click the delete icon to remove individual entries, or use "Delete All Rows" to clear everything
- Click the hide/exclude icon to temporarily hide entries from analysis without deleting them—they'll remain in your data but won't appear in calculations or charts

## How do I see details about a specific customer?
**Keywords:** view details, customer information, data table
...
**Keywords:** midpoint change, manual reassignment, auto clear
...
**Keywords:** undo, revert changes, reset
...
**Keywords:** reset chart, default settings, restore defaults
...
**Keywords:** share, collaborate, team, export for sharing
...
**Keywords:** browser close, lose data, session storage
